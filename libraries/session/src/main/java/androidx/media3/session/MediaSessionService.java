...
public abstract class MediaSessionService extends Service {
   ...
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_CONNECTED = 0;
   ...
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_SESSION_PLAY_REQUESTED = 1;

  /**
   * See {@link MediaSession.Listener#onNotificationRefreshRequired(MediaSession)}
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_SESSION_REFRESH_REQUIRED = 2;

  /**
   * The user engagement timeout expired while the player is paused.
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_ENGAGED_TIMEOUT = 3;

  /**
   * The user engagement timeout was disabled in order to stop the service instantly.
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_ENGAGED_TIMEOUT_DISABLED = 4;
   ...
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_BUTTON_PREFERENCES_CHANGED = 5;
   ...
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_SESSION_COMMANDS_CHANGED = 6;

  /**
   * The MediaNotificationManager controller was disconnected from the session.
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_DISCONNECTED = 7;
   ...
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_PLAYER_EVENT = 8;

  /**
   * The update was triggered because {@link #setShowNotificationForIdlePlayer(int)} was called
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_IDLE_PLAYER_SETTING_CHANGED = 9;

  /**
   * The update was triggered by calling {@link #manuallyUpdateMediaNotification(MediaSession)}
   */
  @UnstableApi
  public static final int NOTIFICATION_UPDATE_MANUAL = 10;
   ...
   */
  @SuppressWarnings("deprecation") // Calling deprecated method.
  public void onUpdateNotification(MediaSession session, boolean startInForegroundRequired, @NotificationUpdate int reason) {
    defaultMethodCalled = false;
    onUpdateNotification(session);
